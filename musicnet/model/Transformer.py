...
class AudioTransformer(keras.Model):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__()
        self.conv1 = keras.layers.Conv1D(d_model, kernel_size=3, padding="same", input_shape=[None, n_mels])
        ...
        self.transformer = Transformer(d_model=d_model, target_classes=target_classes, **kwargs)
