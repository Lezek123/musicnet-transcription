...
from musicnet.utils import instruments_vocab, notes_vocab, load_params
import tensorflow as tf
from tensorflow import keras
...
class AudioTransformer(keras.Model):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__()
        self.config_parmas = { "n_mels": n_mels, "d_model": d_model, "target_classes": target_classes, **kwargs }
        self.conv1 = keras.layers.Conv1D(
            d_model, kernel_size=3, padding="same", input_shape=[None, n_mels]
        )
